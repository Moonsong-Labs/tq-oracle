...
SEPOLIA_ADDRESSES: NetworkAddresses = {
    ...
    "WETH_ADDRESS": None,
    "WSTETH_ADDRESS": None,
    "ORACLE_HELPER": "0x65464fe20562C22B2802B4094d3E042E18b5dfC2",
}

BASE_ADDRESSES: NetworkAddresses = {
    "USDC_ADDRESS": None,
    "USDT_ADDRESS": None,
    "USDS_ADDRESS": None,
    "ETH_ADDRESS": ETH_ASSET,
...
TOKEN_DECIMALS = {
    ETH_MAINNET_ADDRESSES["USDC_ADDRESS"]: 6,
    SEPOLIA_ADDRESSES["USDC_ADDRESS"]: 6,
    ETH_MAINNET_ADDRESSES["USDT_ADDRESS"]: 6,
    ETH_MAINNET_ADDRESSES["USDS_ADDRESS"]: 18,
}
